...
### <font color="FFCCCC">**👥Пример реализации**</font>

В качестве примера работоспособности приведен тест работоспособности сервера и подключения клиента к мессенджеру:

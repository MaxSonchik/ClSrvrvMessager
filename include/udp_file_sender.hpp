...
class UDPFileSender
{
  public:
     ...
     * @return Возвращает `true`, если файл был успешно отправлен. В случае ошибки возвращает
     * `false`.
     */
  ...
  private:
     ...
     * @return Возвращает `true`, если подтверждение получено. В противном случае возвращает
     * `false`.
     */
